...
export const CLINIC_INFO = {
  ...
  address: 'Rua Fidêncio Ramos, 100, 5º andar - Vila Olímpia',
  city: 'São Paulo/SP',
  cep: '04551-010',
  street: 'Rua Fidêncio Ramos, 100',
  complement: '5º andar - Vila Olímpia',
  fullAddress: 'Rua Fidêncio Ramos, 100, 5º andar - Vila Olímpia, São Paulo/SP, CEP 04551-010',
  mapsUrl: 'https://maps.google.com/?q=Rua+Fid%C3%AAncio+Ramos,+100+-+Vila+Ol%C3%ADmpia,+S%C3%A3o+Paulo+-+SP,+04551-010',
